    ...
    int from, int to, Round round )
{
    ...
    if ( boundingRect.isValid() )
    {
        for ( int i = from; i <= to; i++ )
        {
            ...
            if(sample.y() < 0 || sample.y() > 100) {continue;}
...
class MyPointMapper::PrivateData
{
public:
    PrivateData():
    ...
    QRectF boundingRect;
    MyPointMapper::TransformationFlags flags;
};
MyPointMapper::MyPointMapper()
{
...
void MyPointMapper::setFlags( TransformationFlags flags )
{
    d_data->flags = flags;
}

MyPointMapper::TransformationFlags MyPointMapper::flags() const
{
    return d_data->flags;
}
...
/*!
  ...
  \sa flag(), setFlags()
 */
void MyPointMapper::setFlag( TransformationFlag flag, bool on )
{
    if ( on )
        d_data->flags |= flag;
    else
...
/*!
  ...
  \sa setFlag(), setFlags()
 */
bool MyPointMapper::testFlag( TransformationFlag flag ) const
{
...
/*!
  ...
  \sa boundingRect()
 */
void MyPointMapper::setBoundingRect( const QRectF &rect )
{
...
/*!
  ...
  \sa setBoundingRect()
 */
QRectF MyPointMapper::boundingRect() const
{
...
*/
QPolygonF MyPointMapper::toPolygonF(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
...
/*!
  ...
  \return Translated polygon
*/
QPolygon MyPointMapper::toPolygon(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    const QwtSeriesData<QPointF> *series, int from, int to ) const
{
    QPolygon polyline;
...
/*!
  ...
  \return Translated polygon
*/
QPolygonF MyPointMapper::toPointsF(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    const QwtSeriesData<QPointF> *series, int from, int to ) const
{
    QPolygonF points;
...
/*!
  ...
  \return Translated polygon
*/
QPolygon MyPointMapper::toPoints(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    const QwtSeriesData<QPointF> *series, int from, int to ) const
{
    QPolygon points;
